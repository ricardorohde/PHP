	...
	<table width="750" border="0" cellspacing="1" cellpadding="0">
	  ...
	  <tr bgcolor="#FFFFFF">
		<td align="center" valign="middle" style="padding:3px;"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <select name="cmpEstado" class="BoxHome" id="cmpEstado" onchange="javascript:if(this.value=='vazio'){alert('- Escolha um Estado V�lido'); document.getElementById('cmpCidade').disabled=true; document.getElementById('divMeioRepres').style.display='none'; document.getElementById('avisoInicial').style.display='block';}else{incluiPagina('scr_mostra_cidades.php?uf='+this.value+'&tm=<?=time();?>', 'divCidades');}">
